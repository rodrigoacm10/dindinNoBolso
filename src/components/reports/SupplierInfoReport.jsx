...
function SupplierInfoReport({
  ...
  const columns = [
    ...
    },
    {
      ...
      flex: 1,
      renderCell: (params) => {
        return `${params.row.quantidade ? `${+params.row.quantidade}` : "0"}`;
      },
      // editable: true,
    },

    {
      ...
      renderCell: (params) => {
        return `R$ ${
          params.row.custo_total ? params.row.custo_total : "00.00"
        }`;
      },
    },
  ...
  return (
    ...
    >
      ...
      <Box
        ...
        alignItems="center"
      >
        <p className="text-white">resultado das compras no periodo</p>
        <Box
          // width="100%"
          display="flex"
...
export default SupplierInfoReport;
