...
import BuysAction from "./buysAction";

function BuysGrid({ report, change, moviments = [], movToPass = [] }) {
  const {
    attData,
    attDataFunc,
    revenueCats,
  ...
  const columns = [
    {
      ...
      width: 200,
      renderCell: (params) => {
        return <BuysAction {...{ params, rowId, setRowId }} />;
      },
    },
    {
      field: "anexo",
    ...
    },
    {
      ...
      //           allSuppliers[Math.random(10).toFixed(0)]?.nome_contato}
      //       </p>
      //     </div>
      //   );
      // },
    ...
    },
    {
      ...
      align: "center",
      type: "singleSelect",
      getOptionValue: (value) => value.formPayment,
      getOptionLabel: (value) => value.nome,
      valueOptions: [
        {
          formPayment: "vista",
        ...
        {
          formPayment: "vista+prazo",

          nome: "entrada + parcelas",
        },
      ],
      // renderCell: (params) => {
      //   const forms = ["à vista", "à prazo", "à prazo + entrada"];
      //   return (
      //     <div>
      //       <p>{!params.row.formPayment && forms[Math.random(3).toFixed(0)]}</p>
      //     </div>
      //   );
      // },
      minWidth: 100,
  ...
  const getMovs = async () => {
    ...
    // const responseSuppliers = await getSupplier();
    ...
    // setAllSuppliers(responseSuppliers.data);
  ...
  return (
    ...
    >
      ...
      <Box
        ...
        alignItems="center"
      >
        {report && <p className="text-white">entradas no período</p>}
        <Box
          // width="100%"
          display="flex"
